        ...
        <div class="container">
            <div class="footer-grid">
                ...
                <div class="footer-col footer-brand">
                    ...
                    <p class="footer-mission">Raising a generation of relentless intercessors and restored lives through the power of prayer, worship, and the Word of God.</p>
                ...
                <div class="footer-col">
                    ...
                    <ul class="footer-contact">
                        <li>
                            ...
                            <span>Bukuwa Ward, Nabumali Town Council,<br>Mbale, Uganda</span>
                        </li>
                        <li>
                            <i class="fas fa-phone"></i>
                            <span><?= SITE_PHONE1 ?><br><?= SITE_PHONE2 ?></span>
                        </li>
                        <li>
